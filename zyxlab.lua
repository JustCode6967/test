...
do
    ...
    customizePage:Dropdown({
        Title="Glow Preset",
        Desc="Sets glow, border & UI gradient — 30 total",
        List=gpNames, Value=gpNames[1],
        Callback=function(sel)
            for i,p in ipairs(GLOW_PRESETS) do
                if p.n==sel then GM:ApplyPreset(i); break end
            end
        end,
    })
    customizePage:Toggle({
        Title="Enable Glow",Desc="Toggle the outer glow on/off",
        Value=true,Callback=function(v) GM:SetEnabled(v) end,
    })
    customizePage:Slider({
        Title="Glow Size",Desc="Spread beyond the window edge",
        Min=20,Max=200,Rounding=0,Value=90,
        Callback=function(v) GM:SetGlowSize(v) end,
    })
    customizePage:Slider({
        Title="Glow Opacity",Desc="Brightness of the outer glow (0–100)",
        Min=0,Max=100,Rounding=0,Value=60,
        Callback=function(v) GM:SetGlowOpacity(v/100) end,
    })
    customizePage:Toggle({
        Title="Flowing Glow",Desc="Glow gradient spins & color-shifts live",
        Value=true,Callback=function(v) GM.S.flowEnabled=v end,
    })
    customizePage:Toggle({
    ...
    customizePage:Slider({
        ...
        Min=1,Max=8,Rounding=0,Value=2,
        Callback=function(v) GM:SetBorderThick(v) end,
    })
    customizePage:Slider({
        Title="Border Speed",Desc="Color travel speed (1=slow, 20=fast)",
        Min=1,Max=20,Rounding=0,Value=6,
        Callback=function(v) GM.S.borderSpeed=math.clamp(3.8-(v/5.5),0.12,3.8) end,
    })
    customizePage:Toggle({
    ...
    customizePage:Slider({
        ...
        Callback=function(v) GM.S.uiGradSpeed=v*0.033 end,
    })
    ...
    customizePage:Toggle({
        ...
        Value=true,Callback=function(v) GM.S.textAnimOn=v end,
    })
    customizePage:Dropdown({
        ...
        Value="Sweep Left→Right",
        Callback=function(sel)
            local m={["Sweep Left→Right"]="SweepLR",["Sweep Right→Left"]="SweepRL",
            ...
            GM.S.textMode=m[sel] or "SweepLR"
        end,
    })
    customizePage:Slider({
        Title="Text Speed",Desc="How fast the gradient sweeps (1=slow, 10=fast)",
        Min=1,Max=10,Rounding=0,Value=3,
        Callback=function(v) GM.S.textSpeed=v*0.35 end,
    })
